...
- **email**: Email portal (akan replace "bandungterkini@gmail.com")
- **socialHandle**: Handle social media (akan replace "Bandung Terkini")
- **colors**: Tema warna
  - **primary**: Warna utama kuning (contoh: #6D28D9 → custom)
  - **dark**: Warna gelap hitam (contoh: #2E1065 → custom)
...
| `Bandung Terkini` | `siteName` (tanpa spaces) |
| `Bandung Terkini` | `socialHandle` |
| `bandungterkini@gmail.com` | `email` |
| `#6D28D9` (primary) | Warna primary dari config |
| `#2E1065` (dark) | Warna dark dari config |
