...
$textBasedLogo = @"
<span style="font-weight: bold; color: #6D28D9; font-size: 24px; letter-spacing: -0.5px;">WARTA<span style="color: #1F3F5F; font-weight: normal; font-size: 18px; margin-left: 2px;">JANTEN</span></span>
"@
